...
class CategoryController extends Controller
{
    ...
    {
        // Nel metodo bisogna richiamare il modello che estrae tutte le categorie
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect()->route('categories.edit', $category)->with(['success' => 'Categoria modificata correttamente.']);
    }
